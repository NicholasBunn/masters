...
openssl req -x509 -newkey rsa:4096 -days 365 -nodes -keyout ca-key.pem -out ca-cert.pem -subj "/C=ZA/ST=Western Cape/L=Stellenbosch/O=Stelllenbosch University/OU=Engineering/CN=localhost/emailAddress=nicholasbunn@sun.ac.za"
